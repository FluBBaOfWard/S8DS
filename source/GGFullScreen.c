...
static void composeSmoothedLine(u16 *dest, int sourceLine,
...
#endif
	drawSmoothedBackgroundLine(dest, sourceLine, backgroundMap, backgroundTiles,
	...
	started = finished;
#endif
	drawSmoothedSpriteLine(dest, sourceLine, spriteTiles);
#ifdef GG_SMOOTH_PROFILE
	finished = cpuGetTiming();
	smoothProfileCurrent.sprites += finished - started;
	started = finished;
#endif
	drawSmoothedBackgroundLine(dest, sourceLine, foregroundMap, backgroundTiles,
