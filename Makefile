...
DEFINES		:=	-DARM9 -DNDS -DZ80_LARGE_MAP -DZ80_USE_FAST_MEM -DAY_UPSHIFT=2 -DSCC_UPSHIFT=2 -DGG_SMOOTH_DYNAMIC_FRAME_RENDER_SPLITTING=1 -DPICOLIBC_LONG_LONG_PRINTF_SCANF
