...
GAME_TITLE	:= S8DS
GAME_SUBTITLE	:= Sega 8-bit Emulator
...
DEFINES		:=	-DARM9 -DNDS -DZ80_LARGE_MAP -DZ80_USE_FAST_MEM -DAY_UPSHIFT=2 -DSCC_UPSHIFT=2 -DPICOLIBC_LONG_LONG_PRINTF_SCANF

ifeq ($(SMOOTH1_PROFILE),1)
DEFINES		+= -DGG_SMOOTH_PROFILE=1
endif

ifeq ($(DYNAMIC_FRAME_RENDER_SPLITTING),1)
DEFINES		+= -DGG_SMOOTH_DYNAMIC_FRAME_RENDER_SPLITTING=1
endif
